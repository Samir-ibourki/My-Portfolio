    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={iconsRef} className="flex justify-center gap-6 mb-12">
          {[
            { icon: Mail, href: 'mailto:samiribourki7@gmail.com', color: '#00d4ff' },
            { icon: Github, href: 'https://github.com/Samir-ibourki', color: '#ff00ff' },
            { icon: Linkedin, href: 'https://www.linkedin.com/in/samir-ibourki-500255199/', color: '#00ffff' },
            { 
              icon: () => (
